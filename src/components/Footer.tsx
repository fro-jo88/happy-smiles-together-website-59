      ...
      <div className="hmhy-container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <Link to="/" className="inline-block mb-4">
              <img src="/placeholder.svg" alt="HappyMeHappyYou" className="h-16" />
            </Link>
            ...
            <div className="flex space-x-4">
              <a href="#" aria-label="Facebook" className="text-white hover:text-hmhy-blue">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-facebook"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
              </a>
              <a href="#" aria-label="Twitter" className="text-white hover:text-hmhy-blue">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-twitter"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/></svg>
              </a>
              <a href="#" aria-label="Instagram" className="text-white hover:text-hmhy-blue">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-instagram"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
              </a>
              <a href="#" aria-label="YouTube" className="text-white hover:text-hmhy-blue">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <Phone size={20} className="mr-2 mt-1 text-hmhy-green" />
                <span>+254 123 456 789</span>
              </li>
              <li className="flex items-start">
                <Mail size={20} className="mr-2 mt-1 text-hmhy-green" />
                <span>info@happymehappyyou.org</span>
              </li>
              <li className="flex items-start">
                <MapPin size={20} className="mr-2 mt-1 text-hmhy-green" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-10 border-t border-b border-gray-800">
          <div className="text-center">
            ...
            <Link to="/contact" className="text-hmhy-blue hover:text-hmhy-blue-light">Learn More →</Link>
          </div>
          <div className="text-center">
            <h4 className="text-lg font-semibold mb-2">Partner with Us Today</h4>
            <Link to="/contact" className="text-hmhy-blue hover:text-hmhy-blue-light">Get in Touch →</Link>
          </div>
          <div className="text-center">
            <h4 className="text-lg font-semibold mb-2">Join Us to Change Lives</h4>
            <Link to="/donor-dashboard" className="text-hmhy-blue hover:text-hmhy-blue-light">Donate Now →</Link>
          </div>
        </div>
        ...
        <div className="mt-8 pt-4 text-center text-gray-400 text-sm">
          ...
          <p className="mt-2 flex items-center justify-center">
            Made with <Heart size={14} className="mx-1 text-hmhy-yellow" /> for a better tomorrow
          </p>
        </div>
      </div>
    </footer>
